...
{
    // Defines the database context for the ClothConnect application
    public class ApplicationDbContext : DbContext
    {
        // Constructor for ApplicationDbContext, accepting DbContextOptions
        ...
        {
            // Seeding the Category table with predefined data
            ...
            // Seeding the Product table with predefined data
